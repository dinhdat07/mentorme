  ...
  const handleGetStarted = (role: "student" | "tutor") => {
    if (user) {
      window.location.href =
        role === "student" ? "/dashboard/student" : "/dashboard/tutor";
    } else {
    ...
    <div className="min-h-screen bg-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-200">
              Find the perfect tutor for your learning goals or share your
              expertise with students. Transform your education journey today.
            </p>
            ...
            <div className="grid grid-cols-3 gap-8 mt-16 animate-fade-in-up delay-400">
              {[
                ...
                <div key={i} className="group">
                  ...
                  <p className="text-gray-600 mt-2 group-hover:text-gray-900 transition-colors">
                    {stat.label}
                  </p>
                </div>
              ))}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Simple steps to get started on your learning journey
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {/* For Students */}
            <div
              className={`card-hover bg-white rounded-2xl p-10 border border-gray-200 transition-all duration-1000 transform ${
                isLoaded
                ...
                {[
                  {
                    ...
                    desc: "Tell us about your learning goals and preferred subjects",
                  },
                  {
                    title: "Browse Tutors",
                    desc: "Filter by subject, price, and trust score",
                  },
                  {
                    title: "Book a Class",
                    desc: "Try with a trial lesson first",
                  },
                  {
                    title: "Learn & Review",
                    desc: "Get personalized lessons and share your feedback",
                  },
                ].map((item, i) => (
                  <li key={i} className="flex gap-4 group cursor-pointer">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900 group-hover:text-gradient transition-colors">
                        {item.title}
                      </p>
            ...
            {/* For Tutors */}
            <div
              className={`card-hover bg-white rounded-2xl p-10 border border-gray-200 transition-all duration-1000 transform delay-200 ${
                isLoaded
                  ? "opacity-100 translate-x-0"
                  : "opacity-0 translate-x-10"
              }`}
            >
              ...
              <ol className="space-y-6">
                {[
                  {
                    title: "Apply & Verify",
                    desc: "Create your profile with credentials and verify your expertise",
                  },
                  {
                    title: "Set Your Classes",
                    desc: "Create classes with your rates and teaching modes",
                  },
                  {
                    title: "Accept Bookings",
                    desc: "Review student requests and confirm classes",
                  },
                  {
                    title: "Build Your Reputation",
                    desc: "Earn trust scores and positive reviews",
                  },
                ].map((item, i) => (
                  <li key={i} className="flex gap-4 group cursor-pointer">
                    <span className="flex-shrink-0 w-8 h-8 bg-gradient-premium text-white rounded-full flex items-center justify-center font-bold text-sm group-hover:shadow-lg group-hover:scale-110 transition-all duration-300">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-gray-900 mb-4">
              Why Choose Mentor Me?
            </h2>
            <p className="text-xl text-gray-600">
              Experience the best in online education and mentorship
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className={`card-hover bg-white rounded-2xl p-8 border border-gray-200 group transition-all duration-1000 transform delay-${
                  i * 100
                } ${
                  isLoaded
                    ? "opacity-100 translate-y-0"
              ...
              >
                <div
                  className={`flex items-center justify-center w-14 h-14 bg-gradient-to-r ${feature.color} rounded-xl mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
                  <feature.icon className="w-7 h-7 text-white" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-gradient transition-colors">
                  {feature.title}
                </h3>
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-white/90 mb-12">
            Join thousands of students and tutors already learning together on
            Mentor Me
          </p>
